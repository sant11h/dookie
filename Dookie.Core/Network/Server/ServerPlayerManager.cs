...
{
    private readonly ServerNetworkManager _serverLogic;
    ...
    public ServerPlayerManager(ServerNetworkManager serverLogic)
    {
        _serverLogic = serverLogic;
        _antilagSystem = new AntilagSystem(60, ServerNetworkManager.MaxPlayers);
        _players = new ServerPlayer[ServerNetworkManager.MaxPlayers];
        PlayerStates = new PlayerState[ServerNetworkManager.MaxPlayers];
    }
